(function () {
    ...
    e.AmStockChart = e.Class({
        construct: function (a) {
            ...
            var c = this, d = c.categoryAxesSettings;
            setTimeout(function () {
            ...
            var f = this, l = {}, h = a.dataProvider, n = a.categoryField;
            if (n) {
                var g = e.getItemIndex(b, c), m = c.length, q, t = h.length, p, y = {};
            ...
            d = a.stockEvents;
            var l = a.agregatedDataProviders, h = b.length, n, g, m, q, t, p;
            for (n = 0; n < h; n++) {
                p = b[n];
                t = p.graphs;
                m = t.length;
            ...
            for (var y in l) if (l.hasOwnProperty(y)) for (b = l[y], h = e.extractPeriod(y), n = b.length, g = 0; g < d.length; g++) {
                m = d[g];
            ...
            var l = f.period, h = f.count, n = Math.floor(d + (k - d) / 2), g = b[n], m = g[c.categoryField],
                q = this.dataDateFormat, t = m instanceof Date;
            ...
            if (this.div) {
                ...
                if (c != this.prevPH) {
                    ...
                    for (var d = 0, f, b = 0; b < a.length; b++) if (f = a[b]) {
                        var l = f.percentHeight;
                        isNaN(l) && (l = 100 / a.length, f.percentHeight = l);
                        d += l
                    }
                    this.panelsHeight = Math.max(c - e * (a.length - 1), 0);
                    for (b = 0; b < a.length; b++) if (f = a[b]) f.percentHeight = f.percentHeight / d * 100, f.panelBox && (f.panelBox.style.height = Math.round(f.percentHeight * this.panelsHeight / 100) + "px");
                    this.prevPH = c
                }
            }
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (0 < a.dataProvider.length) {
                        ...
                        if (f) {
                            var l = a.agregatedDataProviders[d], h = a.categoryField,
            ...
            if (a) {
                ...
                var f = this.leftContainer, l = this.rightContainer, h = this.centerContainer, n = this.panelsContainer,
                    g = a.width + 2 * c + "px";
                switch (a.position) {
                    case"left":
            ...
            if (a) {
                ...
                this.dssContainer = d;
                var e = this.leftContainer, f = this.rightContainer, l = this.centerContainer, h = this.panelsContainer,
                    c = a.width + 2 * c + "px";
                switch (b) {
                    case"left":
            ...
            var c = this;
            a || (a = c.firstDate);
            var d = e.newDate(a), k = c.firstDate, f = c.lastDate, l = c.currentPeriod, h = c.categoryAxesSettings,
                n = h.minPeriod, g = c.panelsSettings, m = c.periodSelector, q = c.panels, t = c.comparedGraphs,
                p = c.scrollbarChart, y = c.firstDayOfWeek;
            if (k && f) {
                a || (a = k);
                b || (b = f);
                if (l) {
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (l = 0; l < f.length; l++) {
                        var g = f[l], g = e.processObject(g, e.StockGraph, this.theme);
                        f[l] = g;
                        ...
                        if (g.comparable) {
                            ...
                            if (g.valueAxis) {
                                ...
                                var D;
                                for (D = 0; D < B; D++) {
                                    var C = k[D], r = g.comparedGraphs[C.id];
            ...
            var d = this.categoryAxesSettings, k = d.groupToPeriods, f = k[a], l = k[a + 1], h = e.extractPeriod(f),
                h = e.getPeriodDuration(h.period, h.count), n = b.getTime(), g = c.getTime(), m = d.maxSeries;
    ...
    e.PeriodSelector = e.Class({
        construct: function (a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                n.appendChild(m);
                b.startDateField = m;
                if (k) g = b.width - 6 + "px", e.addBr(n); else {
                    var g = b.inputFieldWidth + "px", q = document.createTextNode(" ");
                    n.appendChild(q)
                }
                m.style.width = g;
            ...
            var b = this.dateFormat, c = e.stringToDate(this.startDateField.value, b),
            ...
            var a = this.chart, b = this.periods, c, d = this.theme;
...
(function () {
    ...
    e.StockGraph = e.Class({
        inherits: e.AmGraph, construct: function (a) {
...
(function () {
    ...
    e.StockPanel = e.Class({
        inherits: e.AmSerialChart, construct: function (a) {
            ...
            var a = this, b = a.iconSize, c = a.container, d = a.pathToImages,
                k = a.realWidth - 2 * b - 1 - a.marginRight, f = e.rect(c, b, b, "#000", .005),
            ...
            this.drawOnAxis = b;
            var c = this.categoryAxis, d = a.initialX, k = a.finalX, f = a.initialY;
            a = a.finalY;
            ...
            if (!this.wheelBusy && c) {
                ...
                if (d != e) var f = this.mouseX / this.plotAreaWidth, d = d * f, e = e * (1 - f);
...
(function () {
    ...
    e.StockLegend = e.Class({
        inherits: e.AmLegend, construct: function (a) {
            ...
            if (b.allowTurningOff) {
                var c = a.container, d = c.image(b.pathToImages + "xIcon" + b.extension, b.realWidth - 19, 3, 19, 19),
    ...
    e.DataSetSelector = e.Class({
        construct: function (a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                for (c = 0; c < f.length; c++) if (n = f[c], !0 === n.showInSelect) {
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < f.length) if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), g = b.listCheckBoxSize, l) {
                e.addBr(a);
                ...
                for (c = 0; c < f.length; c++) if (n = f[c], !0 === n.showInCompare && n != b.chart.mainDataSet) {
                    g = document.createElement("option");
                    g.text = n.title;
                    g.value = c;
...
(function () {
    ...
    e.StackedBullet = e.Class({
        construct: function () {
            ...
            b = d.set();
            var k = -1, f = this.stackDown, l = this.graph.valueAxis;
            this.showOnAxis && (this.stackDown = l.reversed ? !0 : !1);
            this.stackDown && (k = 1);
            var h = 0, n = 0, g = 0, m, q = this.fontSize, t = this.mastHeight, p = this.shape, y = this.textColor;
            ...
            var b = -1;
            this.stackDown && (b = 1);
            var c = this.mastHeight * b, d = this.fontSize / 2 + 2,
            ...
            var b = -1;
            this.stackDown && (b = 1);
            var c = this.fontSize + 4, d = this.labelWidth + 6, k = this.mastHeight, b = 1 == b ? b * k : b * k - c,
